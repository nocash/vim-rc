...
" pcntl
syn keyword phpFunctions pcntl_fork pcntl_waitpid pcntl_wait pcntl_signal pcntl_signal_dispatch pcntl_wifexited pcntl_wifstopped pcntl_wifsignaled pcntl_wexitstatus pcntl_wtermsig pcntl_wstopsig pcntl_exec pcntl_alarm pcntl_getpriority pcntl_setpriority pcntl_sigprocmask pcntl_sigwaitinfo pcntl_sigtimedwait contained
...
"Error: 'com_dotnet' Extension com_dotnet does not exist

"Error: 'enchant' Extension enchant does not exist

"Error: 'gmp' Extension gmp does not exist

"Error: 'imap' Extension imap does not exist

"Error: 'intl' Extension intl does not exist

"Error: 'odbc' Extension odbc does not exist

"Error: 'pgsql' Extension pgsql does not exist

"Error: 'sqlite' Extension sqlite does not exist

"Error: 'sqlite3' Extension sqlite3 does not exist

"Error: 'tidy' Extension tidy does not exist

"Error: 'xmlrpc' Extension xmlrpc does not exist
